...
This vignette provides instructions for the hands-on session.
* Note that the vignette is not well rendered in Firefox on the Remote Desktop.  You can get a better looking version straight from CRAN on your own Desktop: [https://cran.r-project.org/web/packages/microhaplot/vignettes/microhaplot-walkthrough.html](https://cran.r-project.org/web/packages/microhaplot/vignettes/microhaplot-walkthrough.html)

* Launch the microhaplot Shiny app by issuing this command in R:
```r
runShinyHaplot("~/Shiny/microhaplot")
```
That will open a FireFox tab with the Shiny App.
* From the dropdown box, choose the `fish2.rds` data set.
...
To do this, go to [https://github.com/ngthomas/microhaplot](https://github.com/ngthomas/microhaplot) and follow the installation instructions.
